...
Exp2=$(curl -sS https://raw.githubusercontent.com/aripTaz/REGISTER/main/IPVPS | grep $MYIP | awk '{print $3}')
...
Name=$(curl -sS https://raw.githubusercontent.com/aripTaz/REGISTER/main/IPVPS | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/aripTaz/REGISTER/main/IPVPS | grep $MYIP | awk '{print $3}')
clear
# // nginx
