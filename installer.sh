...
CEKEXPIRED() {
    ...
    Exp1=$(curl -sS https://raw.githubusercontent.com/aripTaz/REGISTER/main/IPVPS | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/aripTaz/REGISTER/main/IPVPS | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
else
...
wget -q -O https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
RANDOMDOMAIN="https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/menu/"
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
sleep 2
clear
curl "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/menu/ssh-vpn.sh" | bash
sleep 2
wget https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O demeling.sh https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/demeling.sh && chmod +x demeling.sh && ./demeling.sh
...
sleep 2
clear
curl "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/Insshws/insshws.sh" | bash

#exp
cd /usr/bin
wget -O xp "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/menu/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
curl "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/menu/insray.sh" | bash
sleep 1

curl "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/arca.sh" | bash
sleep 1
#install slowdns
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
wget -q -O slowdns.sh https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/SLDNS/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
...
curl "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/ipsec/ipsec.sh" | bash

echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "$green      Install OPENVPN             $NC"
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"

wget "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/Insshws/vpn.sh" && bash vpn.sh && rm vpn.sh
clear
...
wget -q -O /usr/bin/dashboard "https://raw.githubusercontent.com/aripTaz/stunnelvpn/momok/menu/dashboard.sh" && chmod +x /usr/bin/dashboard
# pemberitahuan
